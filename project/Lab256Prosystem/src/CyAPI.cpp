        ...
        if ((BcdUSB & BCDUSBJJMASK) == USB30MAJORVER)
        {
            if(GetInternalBosDescriptor()) // USB3.0 specific descriptor
			{
				...
				catch(char *Str)
				{
					...
					MessageBoxA(NULL,"Please correct firmware BOS descriptor table","Wrong BOS Descriptor",NULL);
...
FX3_FWDWNLOAD_ERROR_CODE CCyFX3Device::DownloadFw(const char *fileName, FX3_FWDWNLOAD_MEDIA_TYPE enMediaType)
{
    UINT fwSize = 0;
    PUCHAR FwImage;
    FILE *FwImagePtr;    
