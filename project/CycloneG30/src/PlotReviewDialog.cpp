...
PlotReviewDialog::PlotReviewDialog(const QString &title,QWidget *parent) : QDialog(parent)
{
    ...
    flags |=Qt::WindowMaximizeButtonHint;//添加最大化按钮
    flags |=Qt::WindowCloseButtonHint;//添加最大化按钮
